...
- При подключении к МК90 модуль монитирует autorun.bin или первый попавшийся образ и работает как обычный МПО/СМП (только на чтение);
